/**
 * Homepage FAQ content, shared between the on-page accordion
 * (components/home/homepage-faq.tsx) and the chat widget's system prompt
 * (lib/chat-context.ts), so the two never drift out of sync.
 */
